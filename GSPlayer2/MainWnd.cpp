...
#ifdef _WIN32_WCE_PPC
#define VOLBAR_LEFT		SCALEX(80)
#define VOLBAR_WIDTH	SCALEX(125)
#define VOLBAR_HEIGHT	SCALEY(8)
#else
...
#define VOLBAR_HEIGHT	8
	...
	RECT rcBar = {TITLE_LEFT + VOLBAR_LEFT, m_nTitleTop + m_nTitleHeight - size.cy + SCALEY(1),
